  ...
  return (
    ...
    >
      <div
        ...
        //       : 'xl:-me-8 4xl:-ms-6')
        // )}
        style={{ paddingTop: '40px' }} // Inline style for adding space at top
      />

      <div className="mx-auto w-full max-w-[1294px] @container @5xl:mt-0 @5xl:pt-12 sm:flex sm:justify-between">
