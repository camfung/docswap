...
import { ActionIcon, Title, Text, Button, Loader } from 'rizzui';
...
export const FileInput = ({
  ...
  async function handleFileUpload() {
    if (files.length) {
      // Create form data for the request and add the files to it
      ...
      // Send the upload request to the server with the multipart form data
      const url = `${process.env.NEXT_PUBLIC_DOCSWAP_API_BASE_URL}/document/upload`;
